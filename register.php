  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="input-group mb-3">
          <select name="level" id="level" for="level" class="form-control">
      ...
      if(isset($_POST['submit'])){
          ...
          // Pastikan Anda juga memeriksa apakah password dan retype_password cocok
          if ($_POST['password'] !== $_POST['retype_password']) {
              echo "<script>alert('Password dan Retype Password tidak cocok.');</script>";
          } else {
              $admin->create($_POST['email'], $encrypted_password, $_POST['nama'], $_POST['level']);
